...
export const SettingsModal: React.FC<SettingsModalProps> = ({ 
  isOpen, onClose, itemsPerSeason, setItemsPerSeason, startYear, endYear, minYear, maxYear, onYearRangeChange, onExportJson, onImportJson, onClearCache, onClearSelection
}) => {
        ...
        <div className="p-6 md:p-8 space-y-8 relative z-10">
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-end">
              ...
              <span className="text-sm text-slate-400 font-mono">{startYear} - {endYear}</span>
            </div>
