...
export const FeaturedSection: React.FC<FeaturedSectionProps> = ({ anime, selectedIds, onToggle }) => (
  <section id="featured" aria-labelledby="featured-title" className="self-start rounded-[var(--ah-radius-lg)] border border-yearbook-line bg-yearbook-surface p-5 shadow-[var(--ah-shadow-soft)] sm:p-6">
        ...
        return (
          ...
          >
            ...
            <div className="min-w-0 py-1">
              ...
              <p className="mt-1 line-clamp-1 text-xs text-yearbook-muted">{item.seasonYear} · {item.format || '动画'} · {item.genres.slice(0, 2).join(' / ')}</p>
