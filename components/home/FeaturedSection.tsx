...
export const FeaturedSection: React.FC<FeaturedSectionProps> = ({ anime, selectedIds, onToggle }) => (
  ...
  >
    <div className="flex items-end justify-between gap-4">
      ...
      <a href="#catalogue" className="shrink-0 text-sm text-yearbook-sky transition hover:text-yearbook-ink">
        查看全部
      </a>
    </div>
          ...
          >
            ...
            <div className="min-w-0 py-1">
              ...
              <p className="mt-1 line-clamp-1 text-xs text-yearbook-muted">
                {item.seasonYear} · {item.format || '动画'} · {item.genres.slice(0, 2).join(' / ')}
              </p>
